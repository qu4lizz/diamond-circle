...
import qu4lizz.diamond_circle.simulation.CurrentPlay;
import qu4lizz.diamond_circle.simulation.ExecutionTime;
...
public class Simulation implements Initializable {
    ...
    public void moveFigureOnMapGrid(PlayerFigure figure) {
        ...
        if (figure.getPath().size() == 1) {
            ...
            BackgroundFill backgroundFill = new BackgroundFill(Color.web("#4c3636"), null, null);
            Background background = new Background(backgroundFill);
            currFigLab.setBackground(background);
        }
    ...
    public void figureFinished(PlayerFigure figure) {
        ...
        BackgroundFill backgroundFill = new BackgroundFill(Color.web("#422727"), null, null);
        Background background = new Background(backgroundFill);
        currFig.second.setBackground(background);
    }
    ...
    public void devourFigure(PlayerFigure figure) {
        ...
        BackgroundFill backgroundFill = new BackgroundFill(Color.web("#422727"), null, null);
        Background background = new Background(backgroundFill);
        fig.second.setBackground(background);
    }
